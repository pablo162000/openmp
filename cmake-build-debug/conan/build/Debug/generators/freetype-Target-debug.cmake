...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET Freetype::Freetype
                 ...
                 $<$<CONFIG:Debug>:${freetype_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${freetype_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${freetype_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${freetype_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET Freetype::Freetype
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${freetype_COMPILE_OPTIONS_DEBUG}> APPEND)

...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET OpenAL::OpenAL
                 ...
                 $<$<CONFIG:Debug>:${openal-soft_LINKER_FLAGS_DEBUG}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${openal-soft_INCLUDE_DIRS_DEBUG}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${openal-soft_LIB_DIRS_DEBUG}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${openal-soft_COMPILE_DEFINITIONS_DEBUG}> APPEND)
    set_property(TARGET OpenAL::OpenAL
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${openal-soft_COMPILE_OPTIONS_DEBUG}> APPEND)
